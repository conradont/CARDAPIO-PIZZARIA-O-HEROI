  ...
  const renderSpinner = () => {
    if (type === "line-spinner") {
      ...
      return (
        ...
        >
          <circle
            style={{ stroke: "var(--fg-brand-primary, #fff)" }}
            cx="16"
            cy="16"
            r="14"
            fill="none"
    ...
    return (
      ...
      >
        <circle
          style={{ stroke: "var(--bg-tertiary, rgba(255, 255, 255, 0.1))" }}
          cx="16"
          cy="16"
          r="14"
          strokeWidth="4"
  ...
  return (
    <div
      ...
      style={{
        ...
        gap: size === "xl" ? "1.25rem" : "1rem",
      }}
    >
      {renderSpinner()}
      {label && (
        <span
          className={cx("text-secondary", styles[size].label)}
          style={{
            color: "var(--text-secondary, rgba(255, 255, 255, 0.7))",
            fontSize: size === "sm" || size === "md" ? "0.875rem" : "1.125rem",
            fontWeight: "500",
          }}
        >
          {label}
